...
from openedx_content.applets.backup_restore.api import load_learning_package_from_path
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            result = load_learning_package_from_path(path, user=user, package_ref=package_ref)
