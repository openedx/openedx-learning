...
def get_collection(learning_package_id: LearningPackage.PK, collection_key: str) -> Collection:
    """
...
def get_entity_collections(learning_package_id: LearningPackage.PK, entity_key: str) -> QuerySet[Collection]:
    """
...
def get_collections(learning_package_id: LearningPackage.PK, enabled: bool | None = True) -> QuerySet[Collection]:
    """
