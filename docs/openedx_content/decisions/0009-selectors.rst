...
- A selector can be of any type, which means it can implement any method to select members from a pool. Therefore, selectors will follow extensibility principles in `0002-content-extensibility.rst <0002-content-extensibility.rst>`_ for creating new selector types.
