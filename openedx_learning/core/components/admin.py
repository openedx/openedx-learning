...
class ComponentAdmin(admin.ModelAdmin):
    ...
    readonly_fields = [
        "learning_package", "uuid", "namespace", "type", "identifier",
        "created", "modified", 
    ]
...
class ContentInline(admin.TabularInline):
    ...
    fields = [
        "identifier", "size", "rendered_data"
    ]
    readonly_fields = [
        "content", "identifier", "size", "rendered_data"
    ]
    extra = 0
...
class ComponentVersionAdmin(admin.ModelAdmin):
    readonly_fields = [
        "component", "uuid", "title", "version_num", "created", "contents"
    ]
    fields = [
        "component", "uuid", "title", "version_num", "created",
    ]
    inlines = [
        ContentInline
    ]
...
class ContentAdmin(admin.ModelAdmin):
    list_display = [
        "learning_package", "hash_digest", "type", "sub_type", "size",
        "created"
    ]
    fields = [
        "learning_package", "hash_digest", "type", "sub_type", "size",
        "created", "rendered_data"
    ]
    readonly_fields = [
        "learning_package", "hash_digest", "type", "sub_type", "size",
        "created", "rendered_data",
