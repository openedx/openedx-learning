...
class GetComponentsTestCase(ComponentTestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        publishing_api.soft_delete_draft(cls.deleted_video.component_pk)
...
class ComponentGetAndExistsTestCase(ComponentTestCase):
    ...
    def test_simple_get(self):
        assert components_api.get_component(self.problem.component_pk) == self.problem
...
class CreateNewVersionsTestCase(ComponentTestCase):
    ...
    def test_add(self):
        ...
        new_version = components_api.get_component(self.problem.component_pk) \
                                    .versions \
